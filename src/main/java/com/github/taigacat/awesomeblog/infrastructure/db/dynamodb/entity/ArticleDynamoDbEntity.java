...
public class ArticleDynamoDbEntity extends Article implements
    DynamoDbEntity<ArticleDynamoDbEntity> {
  ...
  public DynamoDbTable<ArticleDynamoDbEntity> getTable(
    ...
    TableSchema<ArticleDynamoDbEntity> tableSchema = TableSchema.builder(
            ArticleDynamoDbEntity.class)
